# Python 语言特性：编译+解释、动态类型语言、动态语言、运行速度 - qwett1 - 博客园
...
![](https://github.com/Hsu-Outer-Brain/WebCliperCDN_001/blob/main/img3/2022-11-2%2016-55-52/0e6a6da3-897c-44ac-a695-ab02be764cb4.gif?raw=true)
